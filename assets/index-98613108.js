import{c as d,a as D,b as U,u as G,d as l,e as m,i as x,t as p,o as v,f as L,g as $,k as _,h as k,j as y,F,l as T,m as H,n as Y,p as K,q as S,r as X,S as C,s as J}from"./vendor-92de4334.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function e(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(n){if(n.ep)return;n.ep=!0;const r=e(n);fetch(n.href,r)}})();const q=D({}),Q=({theme:i,children:t})=>d(q.Provider,{value:i,children:t}),[V,O]=U({linkStatus:"",detail:""}),M=[V,{jumpLink(i){O(t=>({...t,linkStatus:i}))},setDetail(i){O(t=>({...t,detail:i}))}}],B=D(M),Z=({children:i})=>d(B.Provider,{value:M,children:i}),W=()=>G(B),ee=p("<div><div></div><div><span>ColmugX | TFD"),te=l`
  display: flex;
...
`,ke=p("<div><div>NOTICE</div><div><div><p>换了个风格，但是还没写好</p><p>你可以看到下面的按钮都是灰的</p><br><p>↑↑↓↓←→←→ BA？"),Te=()=>{const i=l`
  ...
  `;return(()=>{const o=ke(),n=o.firstChild,r=n.nextSibling;return m(n,t),m(r,e),k(()=>m(o,y(i,"syuanpi","tvIn","back-3"))),o})()},Se=p("<div><div><p></p></div><div><p>"),Ee=l`
  position: relative;
  background-color: #fff;
...
`,ze=({powerMode:i})=>{const t="ColmugX Homepage";return(()=>{const e=Se(),o=e.firstChild,n=o.firstChild,r=o.nextSibling,c=r.firstChild;return m(e,Ee),m(n,I),x(n,()=>i()?"POWER! ON!":"Welcome!"),m(c,I),x(c,(()=>{const a=T(()=>!!i());return()=>a()?t.toUpperCase():t})()),x(e,d(Te,{}),null),k(a=>{const s=y(N,i()&&P),u=y(N,Ae,i()&&P);return s!==a._v$&&m(o,a._v$=s),u!==a._v$2&&m(r,a._v$2=u),a},{_v$:void 0,_v$2:void 0}),e})()},Ce=p("<div>"),R=l`
  display: flex;
  justify-content: center;
  align-items: center;
  font-size: 24px;
...
`,Oe=l`
  ...
  color: #c0c0c0;
  cursor: not-allowed;
`,Pe=({title:i,powerMode:t,index:e,link:o,disabled:n=!1})=>{const[r,{jumpLink:c,setDetail:a}]=W();let s;const u=()=>{s.className=y(R,t()&&j,n&&Oe)};v(()=>{s.addEventListener("animationend",u)}),L(()=>{s.removeEventListener("animationend",u)});const h=()=>{if(o){c(o);return}a(i),g()},g=()=>{const f=s.getBoundingClientRect();console.log(f.top,f.left,f.width,f.height)};return(()=>{const f=Ce();f.$$click=h;const w=s;return typeof w=="function"?$(w,f):s=f,x(f,i),k(()=>m(f,y(R,"syuanpi","fadeInLeftShort",e?`back-${e}`:null,t()&&j))),f})()};H(["click"]);const Ne=p("<div>"),Ie=l`
  display: flex;
